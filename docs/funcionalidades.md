...
Aqui estão as funcionalidade (features) que o projeto almeja ter, algumas essencias se encaixam no MVP do projeto e serão as primeiras a sem implementadas.
